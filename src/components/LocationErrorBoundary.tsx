...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    if (error.message.includes('Location is not available')) {
      console.error('LocationErrorBoundary caught a location error:', error, errorInfo);
    }
  }
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ 
              ...
              This app needs your location to show accurate Milky Way visibility times. 
              Please allow location access or the app will use Los Angeles as the default location.
            </p>
          </div>
          ...
          <p style={{ 
            ...
            You can change your location anytime using the location button in the app.
          </p>
        </div>
      );
    }
