...
describe("visibilityRating", () => {
  describe("calculateVisibilityRating", () => {
    ...
    const createMockGCData = (
      overrides: Partial<GalacticCenterData> = {},
    ): GalacticCenterData => ({
      altitude: 25,
      azimuth: 180,
    ...
    const createMockMoonData = (
      overrides: Partial<MoonData> = {},
    ): MoonData => ({
      phase: 0.1,
      illumination: 0.05,
      altitude: -10,
    ...
    const createMockTwilightData = (
      overrides: Partial<TwilightData> = {},
    ): TwilightData => ({
    ...
    it("should return valid rating between 0 and 4", () => {
      ...
      const result = calculateVisibilityRating(
        gcData,
        moonData,
        twilightData,
        testLocation,
    ...
    it("should reward high GC altitude", () => {
      ...
      const highRating = calculateVisibilityRating(
        highGCData,
        darkMoonData,
        twilightData,
        testLocation,
      ...
      const lowRating = calculateVisibilityRating(
        lowGCData,
        darkMoonData,
        twilightData,
        testLocation,
    ...
    it("should reward longer dark periods", () => {
      ...
      const longRating = calculateVisibilityRating(
        gcData,
        moonData,
        longDarkData,
        testLocation,
      ...
      const shortRating = calculateVisibilityRating(
        gcData,
        moonData,
        shortDarkData,
        testLocation,
    ...
    it("should handle edge cases without errors", () => {
      ...
      const extremeMoonData = createMockMoonData({
        illumination: 1.0,
        altitude: 90,
      });
      ...
      const minimalMoonData = createMockMoonData({
        illumination: 0,
        altitude: -90,
      });
